...
<script src="<%=basePath%>resource/js/jquery-1.8.2.min.js"></script>
   ...
   <div data-role="header">
	    <div data-role="navbar">
		    <ul>
			    ...
			    <li><a href="<%=basePath %>resource/page/aboutMe.jsp"  data-icon="info">关于阿木</a></li>
			    <li><a href="<%=basePath %>resource/page/contactMe.jsp" data-icon="grid" >联系我</a></li>
		    </ul>
	    </div>
  </div>
